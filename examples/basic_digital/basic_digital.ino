...
void loop() {  
      drv.playWave(WaveForm_1, sizeof(WaveForm_1)); //Play one the Waveforms defined above;
      delay(3000); //Wait for the wave to play;  
      drv.playWave(WaveForm_2, sizeof(WaveForm_2)); //Play one the Waveforms defined above;
      delay(3000); //Wait for the wave to play;  
